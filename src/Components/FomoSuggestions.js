...
export default function FomoSuggestions({ amount, ticker, date, setShowContent }) {
    let localeDate = '';
    if( date ){
    ...
    return (
        ...
        <div onClick={() => {
            ...
            navigate('/tata')
            }} className="hidden md:inline-block hover:cursor-pointer bg-white hover:bg-gray-100 py-2 px-3 text-center border border-gray-700 rounded-lg my-2 mr-2 text-xs">
